...
public class PreGamePane extends StackPane {
	...
	public PreGamePane(int width, int height) {
		...
		this.setStyle(
				"-fx-background-image: url('woodbackground.jpg'); -fx-background-repeat: stretch; -fx-background-position: center center;");
	...
	public void initButtonPane() {
		...
		tooltip.setFont(Font.loadFont(ClassLoader.getSystemResourceAsStream(SimulationManager.fontUrl), 20));
	...
	public void initForm() {
		...
		form.setStyle(
				"-fx-background-image: url('scrollbackground.png'); -fx-background-repeat: stretch; -fx-background-position: center center; -fx-background-size: 700 500;");
