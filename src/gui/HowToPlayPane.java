...
public class HowToPlayPane extends StackPane {
	...
	public HowToPlayPane() {
		...
		super();
		this.setStyle(
				"-fx-background-image: url('woodbackground.jpg'); -fx-background-repeat: stretch; -fx-background-position: center center; -fx-background-size: 800 600;");
	...
	private void loadResource() {
		// load image
		playerOneImgv = new ImageView(new Image(
				ClassLoader.getSystemResource("adventurerSprite/Idle (1).png").toString(), 80, 600 / 8, false, true));
		playerTwoImgv = new ImageView(new Image(
				ClassLoader.getSystemResource("adventurerSprite/Idle (1).png").toString(), 80, 600 / 8, false, true));
	...
	public void initPlayerOnePane() {
		...
		playerOnePane.setStyle(
				"-fx-background-image: url('howtoplaypaper.png'); -fx-background-repeat: stretch; -fx-background-position: center center; -fx-background-size: 700 200;");
